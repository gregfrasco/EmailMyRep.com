...
module.exports = {
  ...
  sendgrid: {
    api_key: process.env.SENDGRID_APIKEY || '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'
  },
  ...
  google: {
    clientID: process.env.GOOGLE_ID || '91711670424-nt44adrdpmvi36hio4b6hjunk3fnvgmm.apps.googleusercontent.com',
    clientSecret: process.env.GOOGLE_SECRET || 'jwhV75ntT-4UONTQ6o4XsvbO',
...
if(process.env.NODE_ENV === 'test-travis') {
  ...
  module.exports.postgres = process.env.DATABASE_URL || 'postgres://emailMyRep:emailMyRep@localhost:5433/emailMyRep';
}
