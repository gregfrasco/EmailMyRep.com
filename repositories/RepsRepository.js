...
*/
/*
repo.getAllRepswithEmails = function(address) {
  ...
  http.get(url, function(res){
    ...
    res.on('end', function(){
      ...
      for (i = 0; i < repsData.length; i++) {
        ...
        newRep.title = repo.addRep(newRep);
      }
    });
  }).on('error', function(e){
    console.log("Got an error: ", e);
